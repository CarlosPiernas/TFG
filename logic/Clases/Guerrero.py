...
class Guerrero(Jugador):
    ...
    magia    : 0
    destreza : 0
    Berserker: cuando le queda 1 solo contador, su ATK efectivo sube +50.
    """
    ...
    def atk_efectivo(self):
        """ATK real del Guerrero: base normal, o base +50 si queda 1 contador."""
        if self.contador_danio == 1:
            return self.atk + self.BONUS_BERSERKER
        return self.atk

    @property
    def berserker_activo(self):
        """True cuando el modo berserker está activo."""
        return self.contador_danio == 1

    def perder_vida_por_golpe(self):
        """El Guerrero siempre pierde exactamente el 25% de vida_max."""
